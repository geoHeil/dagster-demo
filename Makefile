...
## prerequisites
# conda activate base && conda install -c conda-forge mamba && conda deactivate

## Set up python interpreter environment
create_environment: ## create conda environment for analysis
ifeq (True,$(HAS_CONDA))
		@echo ">>> Detected conda, creating conda environment."
		#($(CONDA_ACTIVATE) "ds101-notebookserver" ; mamba env create --name $(PROJECT_NAME) -f environment.yml )
		#($(CONDA_ACTIVATE) "${PROJECT_NAME}-notebookserver" ; mamba env create --name $(PROJECT_NAME) -f environment.yml )
